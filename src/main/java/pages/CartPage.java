...
import webCore.WebClickCommands;
...
public class CartPage extends BasePage{
    ...
    public void userEnterDetailsThroughDataTables(DataTable userCredentials){
        List<Map<String,String>> purchaseDetails = userCredentials.asMaps(String.class,String.class);
        for (Map<String,String> data : purchaseDetails){
            cartPageLoad.until(ExpectedConditions.visibilityOf(cartNameInput)).isDisplayed();
            cartNameInput.sendKeys(data.get("Name"));
            cartCountryInput.sendKeys(data.get("Country"));
            cartCityInput.sendKeys(data.get("City"));
            cartCreditCardInput.sendKeys(data.get("CreditCard"));
            cartMonthInput.sendKeys(data.get("Month"));
            cartMonthInput.sendKeys(data.get("Year"));
        }
    }
